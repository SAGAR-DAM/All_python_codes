...
colors = blue_to_cyan + cyan_to_green + green_to_yellow + yellow_to_red
colors = colors[::-1]
...
for i in range(number_of_pend):
    pend = double_pendulum(m1=40, m2=10, L1=120, L2=150, theta1=np.pi, theta2=s[i], theta1_dot=0.01, theta2_dot=0.01)
    p.append(pend)
...
if(savegif==True):
    ...
    frames[0].save("D:\\Codes\\matplotlib animation\\large_number_of_double_pendulum_animation1.gif", save_all=True, append_images=frames[1:], loop=0, duration=25)
