...
extract_linecut(image, a=coeffs[0], b=coeffs[1], c=coeffs[2], band=5, num_points=image.shape[1],logimage = False, log_image_cutoff=log_image_cutoff,plot_logscale=0)  # Example parabola
