...
# Error fill
ax.fill_between(delay, velocity + v_uerr, velocity - v_lerr, color="k", alpha=0.3)
...
ab = AnnotationBbox(imbox, (12.25, 0.5e7),frameon=False, zorder=10)  # High z-order ensures it's in front
ax.add_artist(ab)
