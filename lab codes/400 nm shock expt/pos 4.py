...
files = glob.glob("D:\\data Lab\\400 vs 800 doppler experiment\\400 pump 400 probe\\04 th april 2024\\pos_1\\pr only\\*.txt")
...
for i in range(0,len(files)):
    ...
    if(i<10):
        print((max(wavelength)-min(wavelength))/len(wavelength))
