...
plt.title("Doppler Velocity of critical surface"+fr"Intensity: 3$\times$"+r"$10^{17}$ W/cm$^2$"+"\n(Red means inside the target)")
...
data = np.column_stack((delay, velocity, v_uerr))

# Open a file to write
with open("D:\\output.txt", "w") as f:
    # Write the first section
    f.write("""Intensity: 3e17 W/cm^2
