...
files_10 = sorted(glob.glob("D:\\data Lab\\400 vs 800 doppler experiment\\400 pump 400 probe\\04 th april 2024\\pos_10\\scan 1\\*.txt"))
...
plt.plot(delay[0:len(peaks)-1],peaks[0:len(peaks)-1]-410.65, 'ro')
plt.plot(delay[0:len(peaks)-1],peaks[0:len(peaks)-1]-410.65, 'k-')
plt.title("Doppler shift")
plt.xlabel("probe delay (ps)")
plt.ylabel("Peak wavelength (nm)")
# plt.xlim(-5,18)
# plt.ylim(-0.125,0.5)
plt.title("Doppler Shift for pos 10")
plt.grid(lw = 1, color = "black")
plt.show() 