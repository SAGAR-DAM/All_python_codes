...
# peaks = []
# delay = np.linspace(12,15,len(files_10)//2)-12.65
# delay = 2*delay/c
...
peaks = []
delay = np.linspace(12,15,len(files_1)//2)-12.65
delay = 2*delay/c
delay = np.around(delay, decimals=3)
...
plt.plot(delay[0:len(peaks)-1],peaks[0:len(peaks)-1]-410.5, 'ro')
plt.plot(delay[0:len(peaks)-1],peaks[0:len(peaks)-1]-410.5, 'k-')
plt.errorbar(x=delay[0:len(peaks)-1],y=peaks[0:len(peaks)-1]-410.5, yerr=np.ones(len(peaks[0:len(peaks)-1]))*0.064,color='r', capsize=1, linewidth=0.5)
plt.title("Doppler shift")
plt.xlabel("probe delay (ps)")
plt.ylabel("Peak wavelength (nm)")
# plt.xlim(-5,18)
...
files_1 = sorted(glob.glob("D:\\data Lab\\400 vs 800 doppler experiment\\400 pump 400 probe\\04 th april 2024\\pos_1\\scan 2\\*.txt"))
...
plt.plot(delay[0:len(peaks)-1],peaks[0:len(peaks)-1]-410.6, 'go')
plt.plot(delay[0:len(peaks)-1],peaks[0:len(peaks)-1]-410.6, 'b-')
plt.errorbar(x=delay[0:len(peaks)-1],y=peaks[0:len(peaks)-1]-410.6, yerr=np.ones(len(peaks[0:len(peaks)-1]))*0.064,color='g', capsize=1, linewidth=0.5)
plt.title("Doppler shift")
plt.xlabel("probe delay (ps)")
plt.ylabel("Peak wavelength (nm)")
# plt.xlim(-5,18)
