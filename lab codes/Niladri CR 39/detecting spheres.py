...
#image=image[150:250,180:280]

plt.imshow(image)
plt.axis("off")
plt.show()

image2=np.asarray(image>0.6)
image3=color.gray2rgb(img_as_ubyte(image2))

angle=np.linspace(0,3*np.pi/4,4)
# Detect blobs (spheres) in the image
blobs_dog = blob_dog(image2, max_sigma=30, threshold=0.01)
