...
imagepath = "D:\\data Lab\\ELI-NP March 2025\\28_03_2025\\spearated out image\\28032025_all_TP_trace_19_15_scan3-[Phosphor]_nanowire_2.tif"
...
def extract_linecut(image, a, b, c, x_range=None, band=0, num_points=1000,logimage=False,log_image_cutoff=7, plot_logscale=False):
    ...
    axes[0].set_title(f"{imagepath[-59:-4]}"+"\nParabolic Linecut on Image")
