...
# %%
imagepath = r"D:\data Lab\ELI-NP March 2025\11_04_2025\separated_TP_images\11042025_ALL_TP_19_50_SCAN2-[Phosphor]_shot4.tif"
...
image = image[a:b,:]
description = r"Nano wires 1.2um sub 100nm diameter gap 300nm height 1um"
...
# %%
trace = get_magnetic_trace(image,coeffs,x_range=None,band=10,tolerance=3)
trace = trace.T
...
cutoff_index_integrated_count = find_index(integrated_count,np.max(integrated_count)*0.9999)
...
boundary_energy_in_MeV1 = 10
boundary_energy_in_MeV2 = 13
