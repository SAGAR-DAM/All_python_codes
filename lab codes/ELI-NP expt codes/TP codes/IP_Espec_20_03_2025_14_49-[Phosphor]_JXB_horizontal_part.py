...
A = np.array(Image.open("D:\\data Lab\\ELI-NP March 2025\\20-03-2025\\ESM data\\separated out image\\IP_Espec_20_03_2025_14_49-[Phosphor]_JXB_horizontal_part.tif"))
# A = A[500:,:]
...
plt.grid(which="both",lw=0.5, color="k")
plt.show()
