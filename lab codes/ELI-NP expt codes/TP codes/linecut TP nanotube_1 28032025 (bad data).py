...
imagepath = "D:\\data Lab\\ELI-NP March 2025\\28_03_2025\\spearated out image\\28032025_all_TP_trace_19_15_scan3-[Phosphor]_nanotube_1.tif"
...
noise = 6600#np.mean(image[-100:,-100:])
pixel_to_mm = 0.025
...
def extract_linecut(image, a, b, c, x_range=None, band=0, num_points=1000,logimage=False,log_image_cutoff=7, plot_logscale=False):
    ...
    axes[0].set_title(f"{imagepath[-52:-4]}"+"\nParabolic Linecut on Image")
...
extract_linecut(image, a=coeffs[0], b=coeffs[1], c=coeffs[2], band=2, num_points=image.shape[1],logimage = False, log_image_cutoff=log_image_cutoff,plot_logscale=1)  # Example parabola
