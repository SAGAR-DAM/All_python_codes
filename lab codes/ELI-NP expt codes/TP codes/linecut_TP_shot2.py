...
imagepath = r"D:\data Lab\ELI-NP March 2025\11_04_2025\separated_TP_images\11042025_ALL_TP_19_50_SCAN2-[Phosphor]_shot2.tif"
...
extract_linecut(image, a=coeffs[0], b=coeffs[1], c=coeffs[2], band=0, num_points=image.shape[1],logimage = False, log_image_cutoff=log_image_cutoff,plot_logscale=1)  # Example parabola
