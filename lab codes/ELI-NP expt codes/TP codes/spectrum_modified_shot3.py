...
image = image[a:b,:]
description = r"Nano wires 1.2$\mu$m sub 100nm diameter gap 300nm height 1$\mu$ "
...
cutoff_index_integrated_count = find_index(integrated_count,np.max(integrated_count)*0.9994)
