...
for i in range(0,140):
    ...
    if(savegif==True or savemp4==True):
...
if savemp4==True:
    # Create a video writer object with the desired frame rate
    frame_rate = 10
    writer = imageio.get_writer('D:\\USAF_imaging.mp4', fps=frame_rate)
    # Append each frame to the video
    for image in gif_image:
