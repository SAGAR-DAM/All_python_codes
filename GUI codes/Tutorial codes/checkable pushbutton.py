...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  1 21:15:21 2023

@author: sagar
"""
'''
This is code to create a button. Enabling or disabling it to checkable. 
changing the colour depending on the state of the check state state of the button.
'''
...
class MainWindow(QMainWindow):
    ...
    def the_button_was_clicked(self, checked):
        ...
        self.buttoncount+=1
        if(self.buttoncount>=10):   #After 10 clicks the buttons becomes dead
