...
def draw_on_image(image,start_point,end_point):
    draw = ImageDraw.Draw(image)
    draw.line((start_point[1],start_point[0],end_point[1],end_point[0]), fill=255, width=5)
    return(image)
...
def show_lined_image(image,image2):
