...
# x=np.linspace(-35,30,1001)      #data along x axis
# y=50*np.exp(-(x+25)**2/5)+30*np.exp(-(x+10)**2/7)+10*np.exp(-(x-20)**2/50)+40*np.exp(-(x-10)**2/0.5)+80*np.exp(-(x-0)**2/5)            #data along y axis
